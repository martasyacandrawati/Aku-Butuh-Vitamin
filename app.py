...
<head>
    ...
    <title>Halaman dengan Sidebar Cerah</title>
    <style>
        /* Mengatur warna teks umum */
        body {
            font-family: Arial, sans-serif;
            color: #333; /* Teks hitam gelap untuk kontras yang lebih baik */
            margin: 0;
            padding: 0;
 ...
 padding: 20px;
        ...
        .sidebar {
            ...
            top: 0;
            left: 0;
            background-color: #ff6347; /* Warna oranye cerah */
            color: white;
            padding-top: 30px;
            font-size: 18px;
        ...
        .sidebar a:hover {
            background-color: #ff4500; /* Warna oranye yang lebih gelap untuk efek hover */
        }
        ...
        h1 {
            font-size: 2.5rem;
            color: #333; /* Teks judul hitam gelap */
        }

        p {
            font-size: 1.2rem;
            color: #555; /* Teks paragraf abu-abu gelap untuk kontras yang baik */
        }
    </style>
</head>
<body>
    <header>
        <h1>Selamat Datang di Halaman Cerah!</h1>
    </header>
