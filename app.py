...
if selection == "Kenali Vitamin":
    ...
    st.markdown("---")
    st.header("VITAMIN B KOMPLEKS")
    st.write("Kekurangan vitamin B kompleks dapat menyebabkan berbagai masalah kesehatan, seperti kelelahan, gangguan saraf, dan masalah kulit. Kekurangan yang parah dapat menyebabkan penyakit seperti beri-beri.") st.write("Sementara itu, konsumsi vitamin B kompleks berlebihan, terutama vitamin B3 (niasin), dapat menyebabkan efek samping seperti ruam, gatal, dan sakit kepala.")
    st.markdown("---")
