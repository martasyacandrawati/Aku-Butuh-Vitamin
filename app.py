...
st.set_page_config(page_title="Vitamin", layout="centered")
...
if selection == "Kenali Vitamin":
    ...
    if  vitamin_b == "Vitamin B1 (Thiamin)":
    ...
    elif  vitamin_b == "Vitamin B2 (Riboflavin)":
         ...
         st.subheader("Contoh Kegunaan Dalam Kehidupan Sehari-hari")
         st.write("Ketika kamu sedang stres atau cemas, maka Vitamin B6 akan membantu kamu untuk menstabilkan mood.")
